...
<div class="form-group">
  ...
  <input  name="first_name" placeholder="Building Name" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<!-- radio checks -->
 <div class="form-group">
                        <label class="col-md-4 control-label">Type of flat</label>
                        <div class="col-md-4">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="hosting" value="yes"/> One BHK
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="hosting" value="no" /> Two BHK
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="hosting" value="no" /> Three BHK
                                </label>
                            </div>
                        </div>
                    </div>
<!--  checksbox -->
 <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="checkbox" value="">Wardrobe 
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                     <input type="checkbox" value="">Swiming Pool
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="radio">
                                <label>
                                     <input type="checkbox" value="">lift Facility
                                </label>
                            </div>
                        </div>
                    </div>
